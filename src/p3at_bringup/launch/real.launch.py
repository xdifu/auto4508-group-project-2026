...
def generate_launch_description():
    ...
    lidar_stack = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "lidar_apply_sensor_config": LaunchConfiguration("lidar_apply_sensor_config"),
            "lidar_scanfreq": LaunchConfiguration("lidar_scanfreq"),
            "lidar_filter_level": LaunchConfiguration("lidar_filter_level"),
            "lidar_laser_enable": LaunchConfiguration("lidar_laser_enable"),
            "lidar_scan_start_deg": LaunchConfiguration("lidar_scan_start_deg"),
            "lidar_scan_stop_deg": LaunchConfiguration("lidar_scan_stop_deg"),
